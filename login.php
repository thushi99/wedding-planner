    ...
    <div class="header">
        ...
        <div class="nav-menu">
            <ul>
                ...
                <li><img src="images/icons/contactus.png" width="20px"><a href="contactus.php">&nbsp;Contact Us</a></li>
                <li><img src="images/icons/login.png" width="20px"><a href="#">&nbsp;Login</a></li>
                <li><img src="images/icons/signup.png" width="21px"><a href="signup.php">&nbsp;Signup</a></li>
            </ul>
        </div>
    </div>
    </header>
...
<!----------------------------------------------------------------------------->
    <div class="signup">
        <form class="login" method="post" action="login.php">
            ...
            <center>Don't you have an account?<a href="signup.php">&nbsp;Signup</a> here.</center>
        </form>
    </div>
